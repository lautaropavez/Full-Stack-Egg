...
public class ServiceEditorial {
    ...
    public void modificarEditorial(String nombre, String nuevonombre) throws Exception{
        try {
            ...
            Editorial editorial2 = editorialDAO.buscarEditorialPorNombre(nuevonombre);
            ...
            if (editorial2 == null) {
                ...
                editorialDAO.guardarEditorial(editorial);
                System.out.println("\nEDITORIAL MODIFICADA CON EXITO\n");
            }else{
                if (editorial2.getNombre().equalsIgnoreCase(nuevonombre)) {
