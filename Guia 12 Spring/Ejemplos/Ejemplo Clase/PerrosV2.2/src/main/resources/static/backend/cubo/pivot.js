...
(function() {
  ...
  aggregators = (function(tpl) {
    return {
      "Cantidad": tpl.count(usFmtInt),
      "Cantidad de Valores Unicos": tpl.countUnique(usFmtInt),
      "Listado de Valores Unicos": tpl.listUnique(", "),
      "Suma": tpl.sum(usFmt),
      ...
      "Cantidad como fraccion del Total": tpl.fractionOf(tpl.count(), "total", usFmtPct),
      "Cantidad como fraccion de Filas": tpl.fractionOf(tpl.count(), "row", usFmtPct),
      "Cantidad como fraccion de Columnas": tpl.fractionOf(tpl.count(), "col", usFmtPct)
    };
  })(aggregatorTemplates);
  ...
  renderers = {
    ...
    "Tabla Grafica": function(pvtData, opts) {
    ...
    "Mapa de Calor x Filas": function(pvtData, opts) {
      return $(pivotTableRenderer(pvtData, opts)).heatmap("rowheatmap");
    },
    "Mapa de Calor x Columnas": function(pvtData, opts) {
  ...
  locales = {
    en: {
      ...
      renderers: renderers,
      localeStrings: {
        renderError: "Un error ocurrió al renderizar los resultados.",
        computeError: "Un error ocurrió al procesar los resultados.",
        uiRenderError: "Un error ocurrió al renderizar la interfaz.",
        selectAll: "Seleccionar Todos",
        selectNone: "Seleccionar Ninguno",
        tooMany: "(demasiados resultados para listarlos)",
