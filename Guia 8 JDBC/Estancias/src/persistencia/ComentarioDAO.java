...
public class ComentarioDAO extends DAO {
    ...
    public void guardarComentario(Comentario c) throws MiExcepcion {
        try {
            if (c == null) {
                throw new MiExcepcion("COMENTARIO INVÁLIDO");
            }
            ...
            throw new MiExcepcion("ERROR AL GUARDAR COMENTARIO");
        }

    }

    //BUSCAR
    public Comentario buscarComentarioPorId(int id) throws MiExcepcion, SQLException {
        ...
        try {
            ...
            //SEGÚN PROFESORA NO ES IMPORTANTE HACER CONSULTAS MULTITABLAS AHORA, VER CLASE 
            consultarBase(sql);
            ...
            while (resultado.next()) {
                ...
                c.setTiempo_min(resultado.getInt(12));
                c.setTiempo_max(resultado.getInt(13));
            ...
            System.out.println(e.getMessage());
            throw new MiExcepcion("ERROR AL OBTENER COMENTARIO");
        } finally {
            desconectarBase();
        }
    ...
    public boolean buscarFamiliaPorCasa(int id_casa) throws MiExcepcion { // REVISAR OBJETIVO DE ESTE METODO
