...
public class GIT {
    ...
    public static void main(String[] args) {
        ...
        * En la barra inferior azul nos dice en que rama estamos parados*/
        ...
        /*
        * Cuando creamos un repositorio nuevo y lo queremos clonar, ponemos arriba la pestaña Ver(View) y dentro de esta --> Paleta de comandos, clonar. Nos pide la url.
        * En HTML hay un pluggin que se llama beautify para que sea mas amigable programar en ese lenguaje.
        */
        /* Video 9 Pildoras Informaticas */
        /*
        * Recomendación: Hacer un main con 4 o 5 ramas y merchearlas todas(el mejor video), min 14.
        */
        /* Video 10 Pildoras Informaticas */
        /*
        * Fork : Sirve para utilizarlo como base de otros proyectos y la mas interesante es para poder colaborar con otros programadores.
        * Entonces siendo el programador que quiere colaborar hago los cambios que desee y hago un commit. Una vez hecho esto hago un pull request (pido que me deje hacer un pull al dueño del repo en su prooyecto)
        * En nuestro repositorio siendo el creador del proyecto, github nos avisa que alguien nos hizo un fork.
        * Vemos como solucionar problema de autenticacion con credenciales.
        * min 19 como hacer pull request al repo del programador creador del proyecto
        */
