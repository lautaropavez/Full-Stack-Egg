...
public class ClienteDAO extends DAO{
    ...
    //BUSCAR
    public Cliente buscarClientePorId(Integer id) throws MiExcepcion {
        try
        {
            ...
            while (resultado.next()){
                ...
                c.setCod_postal(resultado.getString(5));
     ...
     //BUSCAR
    public Cliente buscarClientePorEmail(String email) throws MiExcepcion {
        try {
            // SENTENCIA SQL DE CONSULTA
    ...
    public List<Cliente> obtenerCliente() throws MiExcepcion {
        try{
            ...
            while (resultado.next()){
                //Instancio el objeto c con el constructor vacio de Cliente
                c = new Cliente();
                //Ahora seteo la Casa
                c.setId_cliente(resultado.getInt(1));
                c.setNombre(resultado.getString(2));
                ...
                c.setPais(resultado.getString(7));
                c.setEmail(resultado.getString(8));
                //y ahora agrego el objeto "c" a la lista "clientes"
                clientes.add(c);
            }
            return clientes;
        } catch (SQLException | MiExcepcion e){
            System.out.println(e.getMessage());
            throw new MiExcepcion("ERROR AL OBTENER CLIENTES");
        } finally{
            desconectarBase();
        }
    }
