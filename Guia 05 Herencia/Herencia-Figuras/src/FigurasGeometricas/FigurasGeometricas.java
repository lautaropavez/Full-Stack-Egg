...
//import Figuras.*;   // es mas facil en vez de importar uno por uno
...
public class FigurasGeometricas {
    ...
    public static void main(String[] args) {
       ...
       Circulos nuevo_circulo = new Circulos();
       nuevo_circulo.CrearCirculo();
       nuevo_circulo.calcularArea();
       nuevo_circulo.calcularPerimetro();
       
        System.out.println("----------------------------------------------------");
       
       System.out.println("<<<<< RECTANGULO >>>>>");
       Rectangulos nuevo_rect = new Rectangulos();
       nuevo_rect.CrearRectangulo();
       nuevo_rect.calcularArea();
       nuevo_rect.calcularPerimetro();
    }
