...
public class FamiliaDAO extends DAO{
    ...
    public void guardarFamilia(Familia f) throws MiExcepcion {
        ...
        {
            if (f == null){
                throw new MiExcepcion("Debe indicar la familia");
            }
        ...
        } catch (MiExcepcion e)
        {
            ...
            throw new MiExcepcion("ERROR AL GUARDAR FAMILIA");
        }
    ...
    public Familia buscarFamiliaPorId(int id) throws MiExcepcion, SQLException {
        ...
        try
        {
            ...
            //SINO FUNCIONA LA LINEA DE ARRIBA, sino hay una forma que dijo LA profesora en clase pero dijo que no le demos mucha bola a mostrar todos los datos con INNER JOIN, en JPA lo vamos a ver mejor
            ...
            while (resultado.next())
            {
                ...
                c.setTiempo_min(resultado.getInt(16));
                c.setTiempo_max(resultado.getInt(17));
            ...
            System.out.println(e.getMessage());
            throw new MiExcepcion("ERROR AL OBTENER FAMILIA");
        } finally{
            desconectarBase();
        }
    ...
    public void modificarFamilia(Familia f) throws MiExcepcion {
        ...
        try{
            ...
            System.out.println(e.getMessage());
            throw new MiExcepcion("ERROR AL MODIFICAR FAMILIA");
        }
    }
    ...
    //VERIFICA SI EXISTE CASA FAMILIA
    public boolean verificarCasaFamilia(Integer id_casa) throws MiExcepcion {
        ...
        try {
            ...
            System.out.println(e.getMessage());
            throw new MiExcepcion("ERROR AL OBTENER LA CASA DE FAMILIA");
        } finally {
            desconectarBase();
        }
    }

    //VERIFICA SI EXISTE ALGUNA FAMILIA CON ESE ID
    public boolean verificarId(Integer id) throws MiExcepcion {
