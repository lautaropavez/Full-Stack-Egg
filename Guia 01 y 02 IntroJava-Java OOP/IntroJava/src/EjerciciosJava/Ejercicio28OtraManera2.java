 ...
 */
public class Ejercicio28OtraManera2 {
    ...
    public static void main(String[] args) {
       ...
       System.out.println( " Matriz Grande " );
        ...
        // Contar coordenadas para las cuales coinciden el primer valor de la matriz
        // chica
        contador =  0 ;
        for( int i =  0 ; i <  10 ; i ++ ) {
            for( int j =  0 ; j <  10 ; j ++ ) {
        ...
        // Uso xey para recorrer la matriz chica mientras que jyk recorren la matriz
