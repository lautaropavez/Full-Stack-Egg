...
//            }
    ...
    //ARREGLAR: puse d en editorial y me salio la edit que se llama dead
...
//============================ MÉTODOS DE EDITORIAL ============================ (Manera de revisarlas, primero con datos que existan y luego con datos que no para ver tema excepciones)
    ...
    private void modificarEditorial() throws Exception {
            ...
            Editorial editorial = servicioEditorial.buscarPorNombre(nombreAct); // Al borrar por nombre no le pongo el if porque lo toma en el servicio eliminar por editorial pero como aca lo teniamos que hacer por id si no lo encontraba no llegaba a esa instancia y solo nos tiraba un null.
            if (editorial == null) {
